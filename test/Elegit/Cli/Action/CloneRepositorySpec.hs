...
spec = do
  describe "cmd" $ do
    it "prepares local git repository for further work" $ do
      ...
      runGitActionPure defaultGit (CloneRepository.cmd $ CloneRepositoryData ("url" :| []))
